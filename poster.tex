...
\begin{figure}
  \center\includegraphics{images/image.pdf}  
\end{figure}
...
\begin{mdframed}[style=conclusion.frame]
  ...
  \faHandLeft \vspace{0.02em} 多幹性は「\underline{\textbf{より上層で光を獲得する性質}}」と「\underline{\textbf{下層でより効率的に光を受ける戦術}}」として葉群配置に影響する % 多幹性は進化
  }
\end{mdframed}
\end{multicols}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[ht]
\centering
  \scalebox{0.34}{\begin{tabular}{llrrrrlrlrl} \hline
