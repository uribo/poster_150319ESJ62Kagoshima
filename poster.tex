...
\begin{figure}
  \centering
    \includegraphics[scale=1.6]{images/original/fig1_phylogeny_and_trait-1}
\end{figure}
...
\begin{figure}
 \begin{minipage}{0.25\hsize}
  \centering
   \includegraphics[scale=0.40]{images/original/fig2_sprout_stem_shading_condition-1}
 \end{minipage}
...
\begin{figure}
	\centering
		\includegraphics[scale=0.90]{images/original/fig4_sprout_height-1}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[scale=0.7]{images/original/fig4_sprout_height_pic-1}
\end{figure}
