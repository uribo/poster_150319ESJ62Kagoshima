...
\begin{wrapfigure}{r}{14em}
  \includegraphics[scale=0.8]{/Users/uri/Dropbox/git/Data-analyses/life-history_traits_and_stool_structure/Figure/kn25_phylogenetic_tree_cladogram-1.pdf}
\end{wrapfigure}
...
\faCaretRight １プロット内で20個体以上出現した種 cf. 結果\ding{192}表

\faCaretRight 各種の個体数が最も多いプロット内で胸高直径上位60-90\%の個体を抽出

\faCaretRight 系統独立対比: 系統関係に依存した形質値の偽相関を検証\footnote{系統データはAPG I\hspace{-1pt}I\hspace{-1pt}Iのデータベース (R20120829.new \url{https://github.com/camwebb/tree-of-trees/blob/master/megatrees/R20120829.new}をもとにPhylomatic (Webb and Donoghue 2005 \url{http://phylodiversity.net/phylomatic/})にて作成}
...
\begin{figure}
 \begin{minipage}{0.3\hsize}
  \centering
   \includegraphics[scale=0.36]{images/tmp2.pdf}
