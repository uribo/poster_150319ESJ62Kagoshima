...
\begin{wraptable}{r}{14.5em}\caption{調査対象25種の要約。複幹率が高い種順で並べ、\textcolor{Orange1}{上位}および\textcolor{Blue2}{下位}の５種の行を塗りつぶした。}\vspace{-0.4em}
  \scalebox{0.34}{\begin{tabular}{llrrrrrlll}
  \hline
...
\begin{figure}
	\centering
		\includegraphics[scale=2.0]{images/fig1height_spr_cor.pdf}
\end{figure}
...
\begin{figure}
	\centering
	　　\includegraphics[scale=2.0]{images/fig2height_spr_cor_pic.pdf}
\end{figure}
