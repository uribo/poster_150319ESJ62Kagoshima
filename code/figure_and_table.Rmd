...
```{r fig3_sprout_shoot_self_shade, fig.width = 10, fig.height = 10, eval = TRUE}
# fig.width = 15, 
...
```{r fig3_sprout_shoot_self_shade_pic, fig.width = 10, fig.height = 10, eval = TRUE}
...
```{r fig4_sprout_height, fig.width = 14, fig.height = 14, eval = TRUE}
